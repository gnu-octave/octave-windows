...
<dt class="deftypefn" id="index-release"><span class="category-def">: </span><span><strong class="def-name">release</strong> <code class="def-code-arguments">(<var class="var">obj</var>)</code><a class="copiable-link" href="#index-release"></a></span></dt>
