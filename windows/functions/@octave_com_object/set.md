---
layout: "default"
permalink: "/functions/@octave_com_object/22_octavecomobjectset/"
pkg_name: "windows"
pkg_version: "1.7.0"
pkg_description: "Provides COM interface and additional functionality on Windows"
title: "Windows Toolkit - @octave_com_object/set"
category: "Examples"
func_name: "@octave_com_object/set"
navigation:
- id: "overview"
  name: "Overview"
  url: "/index"
...
<dt class="deftypefn def-line" id="index-set"><span class="category-def">: </span><span><code class="def-type"><var class="var">S</var> =</code> <strong class="def-name">set</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">propname</var>, <var class="var">value</var>)</code><a class="copiable-link" href="#index-set"></a></span></dt>
