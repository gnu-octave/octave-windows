...
<dt class="deftypefn" id="index-win32_005fRegEnumKey"><span class="category-def">Loadable Function: </span><span><code class="def-type">[ <var class="var">rv</var>, <var class="var">code</var> ] =</code> <strong class="def-name">win32_RegEnumKey</strong> <code class="def-code-arguments">(<var class="var">key</var>, <var class="var">subkey</var>)</code><a class="copiable-link" href="#index-win32_005fRegEnumKey"></a></span></dt>
<dd> 
