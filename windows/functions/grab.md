...
<dt class="deftypefn def-line" id="index-grab"><span class="category-def">: </span><span><code class="def-type">[<var class="var">x</var>,<var class="var">y</var>] =</code> <strong class="def-name">grab</strong> <code class="def-code-arguments">(<var class="var">axis</var>)</code><a class="copiable-link" href="#index-grab"></a></span></dt>
<dd> 
